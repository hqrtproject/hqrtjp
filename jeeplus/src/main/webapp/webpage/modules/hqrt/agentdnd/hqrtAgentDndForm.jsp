	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			jp.ajaxForm("#inputForm",function(data){
				if(data.success){
				    jp.success(data.msg);
					jp.go("${ctx}/hqrt/agentdnd/hqrtAgentDnd");
				}else{
				    jp.error(data.msg);
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/hqrt/agentdnd/hqrtAgentDnd"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="hqrtAgentDnd" action="${ctx}/hqrt/agentdnd/hqrtAgentDnd/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">置忙开始时间：</label>
					<div class="col-sm-10">
						<form:input path="startdatetime" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">置忙结束时间：</label>
					<div class="col-sm-10">
						<form:input path="enddatetime" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">置忙时长(单位：秒)：</label>
					<div class="col-sm-10">
						<form:input path="timelen" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">置忙值：</label>
					<div class="col-sm-10">
						<form:input path="dndvalue" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">置忙值描述：</label>
					<div class="col-sm-10">
						<form:input path="dndvaluedesc" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
