...
<body>
		 ...
		 <div class="col-xs-12 col-sm-6 col-md-4" style="!important">
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:input path="customerprovince" htmlEscape="false" maxlength="50"  class=" form-control"/>
			</div>
			<br>
			<br>
	</form:form>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<%-- <shiro:hasPermission name="hqrt:robotchat:hqrtRobotChat:add">
				<button id="add" class="btn btn-primary" onclick="add()">
					<i class="glyphicon glyphicon-plus"></i> 新建
				</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="hqrt:robotchat:hqrtRobotChat:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="hqrt:robotchat:hqrtRobotChat:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission> --%>
			<%-- <shiro:hasPermission name="hqrt:robotchat:hqrtRobotChat:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
			</shiro:hasPermission> --%>
			<shiro:hasPermission name="hqrt:robotchat:hqrtRobotChat:export">
	        		<button id="export" class="btn btn-warning">
					<i class="fa fa-file-excel-o"></i> 导出
				</button>
			 </shiro:hasPermission>
	        <%-- <shiro:hasPermission name="hqrt:robotchat:hqrtRobotChat:view">
