	...
	<div id="search-collapse" class="collapse" style="display: block;">
		<div class="accordion-inner">
		 ...
		 <div class="col-xs-12 col-sm-6 col-md-6" style="height:44px;width:500px;">
			...
			<div class="col-xs-12 col-sm-6 col-md-2" style="height: 44px; width: 500px">
				<label class="label-item single-overflow pull-left"
					title="用户姓名：" style="margin-top: 3px"><font size="4">用户姓名：</font>&nbsp;&nbsp;</label>
				<form:input path="customername" htmlEscape="false" maxlength="50" class=" form-control" style="width:340px;border-radius: 6px;" />
			</div>
			<div class="col-xs-12 col-sm-6 col-md-3" style="height: 44px; width: 500px">
				<label class="label-item single-overflow pull-left" title="会话ID：" style="margin-top: 3px"><font size="4" style="margin-left: 3px">会话&nbsp;&nbsp;I&nbsp;D：</font>&nbsp;&nbsp;</label>
				<form:input path="sessionid" htmlEscape="false" maxlength="50" class=" form-control" style="width:340px;border-radius: 6px;" />
			</div>
			<div class="col-xs-12 col-sm-6 col-md-2" style="height: 44px; width: 500px">
				...
				<form:select path="endreasonno" class="form-control" style="width:340px;border-radius: 6px;">
					...
					<form:options items="${fns:getDictList('endreasonrobot')}" itemLabel="label" itemValue="value" htmlEscape="false" />
				</form:select>
			</div>
