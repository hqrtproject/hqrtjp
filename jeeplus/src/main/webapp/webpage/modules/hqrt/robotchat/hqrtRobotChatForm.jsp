	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			jp.ajaxForm("#inputForm",function(data){
				if(data.success){
				    jp.success(data.msg);
					jp.go("${ctx}/hqrt/robotchat/hqrtRobotChat");
				}else{
				    jp.error(data.msg);
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/hqrt/robotchat/hqrtRobotChat"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="hqrtRobotChat" action="${ctx}/hqrt/robotchat/hqrtRobotChat/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">会话结束原因：1转人工、2客户关闭、3超时结束：</label>
					<div class="col-sm-10">
