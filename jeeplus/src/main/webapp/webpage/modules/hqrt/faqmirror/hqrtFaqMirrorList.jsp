...
<head>
	...
	<%@include file="hqrtFaqMirrorList.js" %>
...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">知识状态明细报表列表</h3>
	</div>
	...
	<div id="search-collapse" class="collapse" style="display:block;">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="hqrtFaqMirror" class="form form-horizontal well clearfix">
