	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			jp.ajaxForm("#inputForm",function(data){
				if(data.success){
				    jp.success(data.msg);
					jp.go("${ctx}/hqrt/agentwork/hqrtAgentWork");
				}else{
				    jp.error(data.msg);
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/hqrt/agentwork/hqrtAgentWork"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="hqrtAgentWork" action="${ctx}/hqrt/agentwork/hqrtAgentWork/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">开始接待时间：</label>
					<div class="col-sm-10">
						<form:input path="startdatetime" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">接待结束时间：</label>
					<div class="col-sm-10">
						<form:input path="enddatetime" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">接待时长(单位：秒)：</label>
					<div class="col-sm-10">
