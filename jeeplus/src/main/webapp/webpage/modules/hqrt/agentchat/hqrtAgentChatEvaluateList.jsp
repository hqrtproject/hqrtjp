...
<html>
<head>
	<title>客户满意度评价管理</title>
	<meta http-equiv="Content-type" content="text/html; charset=utf-8">
	<meta name="decorator" content="ani"/>
	<%@ include file="/webpage/include/bootstraptable.jsp"%>
	<%@include file="/webpage/include/treeview.jsp" %>
	<%@include file="hqrtAgentChatEvaluateList.js" %>
...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">客户满意度评价列表</h3>
	</div>
	...
	<div id="search-collapse" class="collapse" style="display: block;">
		<div class="accordion-inner">
			...
			<div class="col-xs-12 col-sm-6 col-md-5" style="width: 500px;height: 44px">
				<label class="label-item single-overflow pull-left" title="评价星级：" style="margin-top:3px"><font size="4">评价星级：</font>&nbsp;&nbsp;</label>
