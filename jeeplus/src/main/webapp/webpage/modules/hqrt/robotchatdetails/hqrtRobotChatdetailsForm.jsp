	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			jp.ajaxForm("#inputForm",function(data){
				if(data.success){
				    jp.success(data.msg);
					jp.go("${ctx}/hqrt/robotchatdetails/hqrtRobotChatdetails");
				}else{
				    jp.error(data.msg);
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/hqrt/robotchatdetails/hqrtRobotChatdetails"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="hqrtRobotChatdetails" action="${ctx}/hqrt/robotchatdetails/hqrtRobotChatdetails/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
				<div class="form-group">
					<label class="col-sm-2 control-label"><font color="red">*</font>唯一记录标识（主键）：</label>
					<div class="col-sm-10">
						<form:input path="rowguid" htmlEscape="false"    class="form-control required"/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">客户发起咨询的内容：</label>
					<div class="col-sm-10">
						<form:input path="requestcontext" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">机器人回复的内容：</label>
					<div class="col-sm-10">
						<form:input path="responsecontext" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">机器人回复编码:100无回复；200回复知识;300回复推荐：</label>
					<div class="col-sm-10">
						<form:input path="responseno" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">机器人回复编码描述:100无回复；200回复知识;300回复推荐：</label>
					<div class="col-sm-10">
						<form:input path="responsenodesc" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">是否解决了客户的问题(0未评价；1未解决；2已解决)：</label>
					<div class="col-sm-10">
						<form:input path="satisfyno" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">是否解决了客户的问题描述：</label>
					<div class="col-sm-10">
						<form:input path="satisfydesc" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
